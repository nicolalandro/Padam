...
class AdamPadamWeighted(Optimizer):
    ...
    def __init__(self,
        ...
        super(AdamPadamWeighted, self).__init__(params, defaults)

    def __setstate__(self, state):
        super(AdamPadamWeighted, self).__setstate__(state)
    ...
    def step(self, closure=None):
        ...
        for group in self.param_groups:
            for p in group['params']:
                ...
                d_p_padam, step_size_padam = self.padam_step(grad, group, p)

                megred_d_p = group['sgd_w'] * d_p_padam + group['adam_w'] * d_p_adam
                # print(f'[{d_p_adam}, {d_p_sgd}, {megred_d_p}],')
                merged_lr = group['sgd_w'] * step_size_padam + group['adam_w'] * step_size
